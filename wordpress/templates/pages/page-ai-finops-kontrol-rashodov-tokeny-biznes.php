...
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap h1,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap h2,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap h3,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap h4,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap h5,
.ai-finops-kontrol-rashodov-tokeny-biznes-page h6 {
    color: #0f172a !important;
    word-wrap: break-word;
    overflow-wrap: anywhere;
}
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap p,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap li,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-section strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-prose strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-content-section strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .claude-intro-section strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ai-finops-intro-section strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page [class*='-intro-section'] strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-faq-section strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-cta-panel strong,
.ai-finops-kontrol-rashodov-tokeny-biznes-page .ym-toc-wrap strong,
...
<div class="finops-hero-grid">
  ...
  <div class="finops-hero-stage" aria-hidden="true">
    <canvas id="hero-finops-canvas"></canvas>
  </div>
</div>
</section>
...
<p><strong>Готовы считать операцию, а не пилоты?</strong> Запросите консультацию по внедрению ИИ с прозрачной unit-экономикой: аудит API, gateway, hard caps и окупаемость на реальных процессах.</p>
  ...
  <a class="ym-btn ym-btn-primary" href="<?php echo esc_url( nn_cta_url( 'primary' ) ); ?>" target="_blank" rel="noopener noreferrer"><span>Консультация: аудит API и unit-экономика</span></a>
</div>
    </div>
  </div>
</section>
