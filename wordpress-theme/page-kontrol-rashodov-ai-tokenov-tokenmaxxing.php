...
#hero-tokenops.fullscreen-white-office {
  min-height: 100vh;
  min-height: 100dvh;
  position: relative;
}
.kontrol-rashodov-intro-section { padding: 56px 0 32px; }
...
<section id="hero-tokenops" class="fullscreen-white-office tokops-hero" aria-label="Tokenmaxxing и контроль AI-бюджета">
<style>
  #hero-tokenops.fullscreen-white-office {
    position: relative;
    overflow: hidden;
  ...
  #hero-tokenops.fullscreen-white-office::before {
    content: "";
    position: absolute;
    inset: 0;
    background-image:
  ...
  #hero-tokenops canvas#hero-tokenops-canvas {
    position: absolute;
    inset: 0;
    width: 100%;
    height: 100%;
  ...
  #hero-tokenops .tokops-hero-copy {
    position: absolute;
  ...
  #hero-tokenops .telegram-button:hover { transform: translateY(-2px); }
  #hero-tokenops .vl-ui-tasks.tokops-stages-row {
    position: absolute;
  ...
  #hero-tokenops .vl-ui-pill.tokops-pill-tr {
    position: absolute;
    right: clamp(16px, 4vw, 48px);
...
<canvas id="hero-tokenops-canvas" aria-hidden="true"></canvas>

<div class="vl-ui-tasks tokops-stages-row" role="list" aria-label="Этапы TokenOps">
