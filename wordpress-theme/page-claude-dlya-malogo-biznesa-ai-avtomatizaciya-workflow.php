...
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page h1,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page h2,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page h3,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page h4,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page h5,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page h6 {
    color: #0f172a !important;
    word-wrap: break-word;
    overflow-wrap: anywhere;
}
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page p,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page li,
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page span:not(.ym-mac-dot):not(.ym-comment):not(.ym-command):not(.ym-btn-primary span),
.claude-dlya-malogo-biznesa-ai-avtomatizaciya-workflow-page strong,
...
.smb-workflow-hero .smb-hero-copy {
  position: relative;
  z-index: 4;
...
.smb-workflow-hero .telegram-button {
  display: inline-flex;
  align-items: center;
  gap: 8px;
  margin-top: 24px;
...
.smb-workflow-hero .telegram-button:hover { transform: translateY(-2px); }
...
@media (max-width: 900px) {
  .smb-workflow-hero .vl-ui-tasks { max-width: 220px; }
  .smb-workflow-hero .vl-ui-task { font-size: 12px; padding: 8px 12px; }
  .smb-workflow-hero .vl-ui-pill { left: 16px; right: 16px; justify-content: flex-start; top: auto; bottom: 8px; }
  .smb-workflow-hero .vl-ui-tasks { bottom: 120px; }
}
</style>

<div class="smb-hero-canvas-wrap" aria-hidden="true">
...
<div class="smb-hero-copy">
  ...
  <a class="telegram-button" href="https://t.me/neronetwork" target="_blank" rel="noopener noreferrer">Разбор workflow в Telegram →</a>
</div>

<div class="vl-ui-tasks" aria-label="Этапы AI-workflow">
